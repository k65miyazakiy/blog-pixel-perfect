...
<Img src="/2025/mdx-type-check/no-error.png" alt="型チェック発生せず" />
...
デフォルトではタイプヒントは控えめと書かれておりわかるようなわからないようなといったところですが、
実際にはこれを指定しないとMDXファイルで型チェックが行われません。
...
<Img src="/2025/mdx-type-check/with-error.png" alt="型チェック発生" />

<Img src="/2025/mdx-type-check/suggestion.png" alt="サジェスト" />

いくらか快適になりますね。

## 設定方法の参考情報

以上の設定までに紆余曲折ありましたが、最終的に一番参考になったのが公式レポジトリの[試験フィクスチャ](https://github.com/mdx-js/mdx-analyzer/tree/main/fixtures/provide)でした。
